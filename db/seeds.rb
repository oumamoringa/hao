...
tenant1 = Tenant.create(full_name:"Lisa",property_id: property1.id)
tenant2 = Tenant.create(full_name:"Joseph",property_id: property2.id)
tenant3 = Tenant.create(full_name:"Richard",property_id: property3.id)
tenant4 = Tenant.create(full_name:"Oscar",property_id: property4.id)
tenant5 = Tenant.create(full_name:"Chris",property_id: property5.id)
